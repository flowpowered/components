# Flow Components [![License](http://img.shields.io/badge/license-MIT-lightgrey.svg?style=flat)][License] [![Flattr this](http://img.shields.io/badge/flattr-donate-lightgrey.svg?style=flat)][Donate] [![Build Status](http://img.shields.io/travis/flow/flow-components/master.svg?style=flat)](https://travis-ci.org/flow/flow-components) [![Coverage Status](http://img.shields.io/coveralls/flow/flow-components/master.svg?style=flat)](https://coveralls.io/r/flow/flow-components)

Component system framework library for use in game engines.

## Getting Started
* [Examples and code snippets](https://github.com/flow/examples/tree/master/components)
* [Official documentation](#documentation)
* [IRC support chat](http://kiwiirc.com/client/irc.esper.net/flow)
* [Issues tracker](https://github.com/flow/flow-components/issues)

## Source Code
The latest and greatest source can be found here on [GitHub](https://github.com/flow/flow-components). If you are using Git, use this command to clone the project:

    git clone git://github.com/flow/flow-components.git

Or download the [latest zip archive](https://github.com/flow/flow-components/archive/master.zip).
...
If you're using [Gradle](http://www.gradle.org/) to manage project dependencies, simply include the following in your `build.gradle` file:
    ...
    dependencies {
        compile 'com.flowpowered:flow-components:0.1.0-SNAPSHOT'
    }

If you'd prefer to manually import the latest .jar file, you can get it [here](https://github.com/flow/flow-components/releases).

## Documentation
Want to get friendly with the project and put it to good use? Check out the latest [Javadocs](http://components.flowpowered.com/).
...
## Legal Stuff
Flow Components is licensed under the [MIT License][License]. Basically, you can do whatever you want as long as you include the original copyright. Please see the `LICENSE.txt` file for details.
...
[Donate]: https://flattr.com/submit/auto?user_id=spout&url=https://github.com/flow/flow-components&title=Flow+Components&language=Java&tags=github&category=software
